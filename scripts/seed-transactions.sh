...
echo -e "  - ${GREEN}5 agents${NC} - RealtorAgent: agent1-5 (alice/bob NOT used)"
echo -e "  - ${GREEN}3 brokers${NC} - RealtorBroker: broker1-3"
...
echo -e "  - ${GREEN}10 citizens${NC} - PrivateCitizen: 5 heavy users with 12 tx each, 5 regular with 2 tx each"
echo -e "  - ${GREEN}ALL citizens${NC} now have valid Government ID credentials"
echo -e "  - ${YELLOW}NOTE${NC}: alice and bob have VCs only and are not used in transactions"
